...
import {Box, CardMedia, Container, Link, makeStyles, Toolbar} from "@material-ui/core";
            ...
            <Container className={classes.root}>
                <Box>
                    ...
                    <Typography className={classes.subTitle} gutterBottom component="p">
                        Компания «Д1аэц запчастьш» более 10 лет предоставляет качественные услуги автопроката в Москве.
                ...
                <Grid container spacing={6}>
                    <Grid item={4} className={classes.logo}>
